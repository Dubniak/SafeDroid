...
class VMAnalysis :
    ...
    def get_methods_for_package(self, class_name, method_regex, descriptor):
        return [l.get_name() for l in self.get_tainted_packages().search_methods(class_name, method_regex, descriptor)]
